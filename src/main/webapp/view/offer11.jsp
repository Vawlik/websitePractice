...
<div class="container-text">
    <br>
    <div class="page-text">
        <h1>Домовладение, 94м<sup>2</sup></h1>
        <p>Белгород, Белгородский район, р-н Восточный</p>
    </div>
    <div id="carouselExampleIndicators" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="../economyFrame/offer11_photo1.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="../economyFrame/offer11_photo2.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="../economyFrame/offer11_photo3.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="../economyFrame/offer11_photo4.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="../economyFrame/offer11_photo5.png" class="d-block w-100" alt="...">
            </div>
        </div>
    ...
    <div>
        ...
        <iframe class="map-container" src="https://yandex.ru/map-widget/v1/-/CCUHNDB5DC" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
</div>
