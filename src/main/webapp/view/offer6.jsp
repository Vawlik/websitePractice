...
<div class="container-text">
    ...
    <div class="page-text">
        ...
        <p>Сочи, Центральный район, микрорайон Мамайка, Виноградная</p>
    </div>
    <div id="carouselExampleIndicators" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="../rentalFrame/offer6_photo1.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="../rentalFrame/offer6_photo2.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="../rentalFrame/offer6_photo3.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="../rentalFrame/offer6_photo4.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="../rentalFrame/offer6_photo5.png" class="d-block w-100" alt="...">
            </div>
        </div>
    ...
    <div>
        ...
        <iframe class="map-container" src="https://yandex.ru/map-widget/v1/-/CDUtQcB" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
</div>
